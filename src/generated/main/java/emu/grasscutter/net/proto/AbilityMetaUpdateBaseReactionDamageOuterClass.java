...
public final class AbilityMetaUpdateBaseReactionDamageOuterClass {
  ...
  public interface AbilityMetaUpdateBaseReactionDamageOrBuilder extends
    ...
    /**
     * <code>.AbilityString global_value_key = 3;</code>
    ...
    /**
     * <code>uint32 OHFDJDLJKFL = 4;</code>
     * @return The oHFDJDLJKFL.
     */
    int getOHFDJDLJKFL();

    /**
     * <code>uint32 FJLMNNFJNGM = 11;</code>
     * @return The fJLMNNFJNGM.
     */
    int getFJLMNNFJNGM();
  }
  /**
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int GLOBAL_VALUE_KEY_FIELD_NUMBER = 3;
    ...
    public static final int OHFDJDLJKFL_FIELD_NUMBER = 4;
    private int oHFDJDLJKFL_;
    /**
     * <code>uint32 OHFDJDLJKFL = 4;</code>
     * @return The oHFDJDLJKFL.
     */
    @java.lang.Override
    public int getOHFDJDLJKFL() {
      return oHFDJDLJKFL_;
    }

    public static final int FJLMNNFJNGM_FIELD_NUMBER = 11;
    private int fJLMNNFJNGM_;
    /**
     * <code>uint32 FJLMNNFJNGM = 11;</code>
     * @return The fJLMNNFJNGM.
     */
    @java.lang.Override
    public int getFJLMNNFJNGM() {
      return fJLMNNFJNGM_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (globalValueKey_ != null) {
        output.writeMessage(3, getGlobalValueKey());
      }
      if (oHFDJDLJKFL_ != 0) {
        output.writeUInt32(4, oHFDJDLJKFL_);
      }
      if (abilityIdentifier_ != null) {
        output.writeMessage(6, getAbilityIdentifier());
      }
      if (fJLMNNFJNGM_ != 0) {
        output.writeUInt32(11, fJLMNNFJNGM_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (globalValueKey_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(3, getGlobalValueKey());
      }
      if (oHFDJDLJKFL_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(4, oHFDJDLJKFL_);
      }
      if (abilityIdentifier_ != null) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (fJLMNNFJNGM_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(11, fJLMNNFJNGM_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getOHFDJDLJKFL()
          != other.getOHFDJDLJKFL()) return false;
      if (getFJLMNNFJNGM()
          != other.getFJLMNNFJNGM()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + OHFDJDLJKFL_FIELD_NUMBER;
      hash = (53 * hash) + getOHFDJDLJKFL();
      hash = (37 * hash) + FJLMNNFJNGM_FIELD_NUMBER;
      hash = (53 * hash) + getFJLMNNFJNGM();
    ...
    public static final class Builder extends
      ...
      public emu.grasscutter.net.proto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamage buildPartial() {
        ...
        result.oHFDJDLJKFL_ = oHFDJDLJKFL_;
        result.fJLMNNFJNGM_ = fJLMNNFJNGM_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.AbilityMetaUpdateBaseReactionDamageOuterClass.AbilityMetaUpdateBaseReactionDamage other) {
        ...
        if (other.getOHFDJDLJKFL() != 0) {
          setOHFDJDLJKFL(other.getOHFDJDLJKFL());
        }
        if (other.getFJLMNNFJNGM() != 0) {
          setFJLMNNFJNGM(other.getFJLMNNFJNGM());
        }
      ...
      /**
       * <code>uint32 OHFDJDLJKFL = 4;</code>
       * @param value The oHFDJDLJKFL to set.
       * @return This builder for chaining.
       */
      public Builder setOHFDJDLJKFL(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearOHFDJDLJKFL() {
      ...
      /**
       * <code>uint32 FJLMNNFJNGM = 11;</code>
       * @param value The fJLMNNFJNGM to set.
       * @return This builder for chaining.
       */
      public Builder setFJLMNNFJNGM(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearFJLMNNFJNGM() {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ionDamage\022.\n\022ability_identifier\030\006 \001(\0132\022." +
      "AbilityIdentifier\022$\n\014ability_name\030\001 \001(\0132" +
      "\016.AbilityString\022(\n\020global_value_key\030\003 \001(" +
      "\0132\016.AbilityString\022\023\n\013OHFDJDLJKFL\030\004 \001(\r\022\023" +
      "\n\013FJLMNNFJNGM\030\013 \001(\rB\033\n\031emu.grasscutter.n" +
      "et.protob\006proto3"
    };
    ...
    internal_static_AbilityMetaUpdateBaseReactionDamage_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_AbilityMetaUpdateBaseReactionDamage_descriptor,
        new java.lang.String[] { "AbilityIdentifier", "AbilityName", "GlobalValueKey", "OHFDJDLJKFL", "FJLMNNFJNGM", });
    emu.grasscutter.net.proto.AbilityIdentifierOuterClass.getDescriptor();
    emu.grasscutter.net.proto.AbilityStringOuterClass.getDescriptor();
  }
