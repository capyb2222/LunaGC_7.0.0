...
public final class AchievementAllDataNotifyOuterClass {
  ...
  public interface AchievementAllDataNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .Achievement achievement_list = 6;</code>
     */
    ...
    /**
     * <code>repeated uint32 reward_taken_goal_id_list = 12;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int ACHIEVEMENT_LIST_FIELD_NUMBER = 6;
    ...
    public static final int REWARD_TAKEN_GOAL_ID_LIST_FIELD_NUMBER = 12;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < achievementList_.size(); i++) {
        output.writeMessage(6, achievementList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < achievementList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(6, achievementList_.get(i));
      }
      {
        int dataSize = 0;
        for (int i = 0; i < rewardTakenGoalIdList_.size(); i++) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "&\n\020achievement_list\030\006 \003(\0132\014.Achievement\022" +
      "!\n\031reward_taken_goal_id_list\030\014 \003(\rB?\n\031em" +
