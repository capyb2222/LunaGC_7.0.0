...
public final class AvatarSatiationDataNotifyOuterClass {
  ...
  public interface AvatarSatiationDataNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .AvatarSatiationData satiation_data_list = 5;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int SATIATION_DATA_LIST_FIELD_NUMBER = 5;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < satiationDataList_.size(); i++) {
        output.writeMessage(5, satiationDataList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < satiationDataList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(5, satiationDataList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ataNotify\0221\n\023satiation_data_list\030\005 \003(\0132\024" +
