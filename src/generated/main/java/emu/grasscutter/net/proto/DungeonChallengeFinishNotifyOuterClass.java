...
public final class DungeonChallengeFinishNotifyOuterClass {
  ...
  public interface DungeonChallengeFinishNotifyOrBuilder extends
    ...
    /**
     * <code>uint32 current_value = 8;</code>
     * @return The currentValue.
     */
    int getCurrentValue();

    /**
     * <code>.CustomDungeonResultInfo custom_dungeon_result_info = 311;</code>
    ...
    /**
     * <code>.PotionDungeonResultInfo potion_dungeon_result_info = 1201;</code>
    ...
    /**
     * <code>.ChannellerSlabLoopDungeonResultInfo channeller_slab_loop_dungeon_result_info = 1270;</code>
    ...
    /**
     * <code>.EffigyChallengeDungeonResultInfo effigy_challenge_dungeon_result_info = 1912;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public enum DetailCase
      ...
      CUSTOM_DUNGEON_RESULT_INFO(311),
      POTION_DUNGEON_RESULT_INFO(1201),
      CHANNELLER_SLAB_LOOP_DUNGEON_RESULT_INFO(1270),
      EFFIGY_CHALLENGE_DUNGEON_RESULT_INFO(1912),
      DETAIL_NOT_SET(0);
      ...
      public static DetailCase forNumber(int value) {
        switch (value) {
          case 311: return CUSTOM_DUNGEON_RESULT_INFO;
          case 1201: return POTION_DUNGEON_RESULT_INFO;
          case 1270: return CHANNELLER_SLAB_LOOP_DUNGEON_RESULT_INFO;
          case 1912: return EFFIGY_CHALLENGE_DUNGEON_RESULT_INFO;
    ...
    public static final int CURRENT_VALUE_FIELD_NUMBER = 8;
    ...
    public static final int CUSTOM_DUNGEON_RESULT_INFO_FIELD_NUMBER = 311;
    /**
     * <code>.CustomDungeonResultInfo custom_dungeon_result_info = 311;</code>
     * @return Whether the customDungeonResultInfo field is set.
     */
    ...
    public static final int POTION_DUNGEON_RESULT_INFO_FIELD_NUMBER = 1201;
    /**
     * <code>.PotionDungeonResultInfo potion_dungeon_result_info = 1201;</code>
     * @return Whether the potionDungeonResultInfo field is set.
     */
    ...
    public static final int CHANNELLER_SLAB_LOOP_DUNGEON_RESULT_INFO_FIELD_NUMBER = 1270;
    /**
     * <code>.ChannellerSlabLoopDungeonResultInfo channeller_slab_loop_dungeon_result_info = 1270;</code>
     * @return Whether the channellerSlabLoopDungeonResultInfo field is set.
     */
    ...
    public static final int EFFIGY_CHALLENGE_DUNGEON_RESULT_INFO_FIELD_NUMBER = 1912;
    /**
     * <code>.EffigyChallengeDungeonResultInfo effigy_challenge_dungeon_result_info = 1912;</code>
     * @return Whether the effigyChallengeDungeonResultInfo field is set.
     */
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (currentValue_ != 0) {
        output.writeUInt32(8, currentValue_);
      }
      ...
      if (detailCase_ == 311) {
        output.writeMessage(311, (emu.grasscutter.net.proto.CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo) detail_);
      }
      if (detailCase_ == 1201) {
        output.writeMessage(1201, (emu.grasscutter.net.proto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfo) detail_);
      }
      if (detailCase_ == 1270) {
        output.writeMessage(1270, (emu.grasscutter.net.proto.ChannellerSlabLoopDungeonResultInfoOuterClass.ChannellerSlabLoopDungeonResultInfo) detail_);
      }
      if (detailCase_ == 1912) {
        output.writeMessage(1912, (emu.grasscutter.net.proto.EffigyChallengeDungeonResultInfoOuterClass.EffigyChallengeDungeonResultInfo) detail_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (currentValue_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(8, currentValue_);
      }
      if (finishType_ != emu.grasscutter.net.proto.ChallengeFinishTypeOuterClass.ChallengeFinishType.CHALLENGE_FINISH_TYPE_NONE.getNumber()) {
        size += com.google.protobuf.CodedOutputStream
      ...
      if (detailCase_ == 311) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(311, (emu.grasscutter.net.proto.CustomDungeonResultInfoOuterClass.CustomDungeonResultInfo) detail_);
      }
      if (detailCase_ == 1201) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1201, (emu.grasscutter.net.proto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfo) detail_);
      }
      if (detailCase_ == 1270) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1270, (emu.grasscutter.net.proto.ChannellerSlabLoopDungeonResultInfoOuterClass.ChannellerSlabLoopDungeonResultInfo) detail_);
      }
      if (detailCase_ == 1912) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(1912, (emu.grasscutter.net.proto.EffigyChallengeDungeonResultInfoOuterClass.EffigyChallengeDungeonResultInfo) detail_);
      }
    ...
    public static final class Builder extends
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.CustomDungeonResultInfoOuterClass.CustomDungeonResultInfoOrBuilder getCustomDungeonResultInfoOrBuilder() {
        if ((detailCase_ == 311) && (customDungeonResultInfoBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.PotionDungeonResultInfoOuterClass.PotionDungeonResultInfoOrBuilder getPotionDungeonResultInfoOrBuilder() {
        if ((detailCase_ == 1201) && (potionDungeonResultInfoBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.ChannellerSlabLoopDungeonResultInfoOuterClass.ChannellerSlabLoopDungeonResultInfoOrBuilder getChannellerSlabLoopDungeonResultInfoOrBuilder() {
        if ((detailCase_ == 1270) && (channellerSlabLoopDungeonResultInfoBuilder_ != null)) {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.EffigyChallengeDungeonResultInfoOuterClass.EffigyChallengeDungeonResultInfoOrBuilder getEffigyChallengeDungeonResultInfoOrBuilder() {
        if ((detailCase_ == 1912) && (effigyChallengeDungeonResultInfoBuilder_ != null)) {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "Type.proto\032\035CustomDungeonResultInfo.prot" +
      "o\032\035PotionDungeonResultInfo.proto\032)Channe" +
      "llerSlabLoopDungeonResultInfo.proto\032&Eff" +
      "igyChallengeDungeonResultInfo.proto\"\304\005\n\034" +
      "DungeonChallengeFinishNotify\022\\\n\031strength" +
      "en_point_data_map\030\001 \003(\01329.DungeonChallen" +
      "geFinishNotify.StrengthenPointDataMapEnt" +
      "ry\022\027\n\017challenge_index\030\005 \001(\r\022\025\n\ris_new_re" +
      "cord\030\013 \001(\010\022\022\n\nis_success\030\004 \001(\010\022)\n\013finish" +
      "_type\030\n \001(\0162\024.ChallengeFinishType\022\021\n\ttim" +
      "e_cost\030\007 \001(\r\022\035\n\025challenge_record_type\030\016 " +
      "\001(\r\022\025\n\rcurrent_value\030\010 \001(\r\022?\n\032custom_dun" +
      "geon_result_info\030\267\002 \001(\0132\030.CustomDungeonR" +
      "esultInfoH\000\022?\n\032potion_dungeon_result_inf" +
      "o\030\261\t \001(\0132\030.PotionDungeonResultInfoH\000\022Y\n(" +
      "channeller_slab_loop_dungeon_result_info" +
      "\030\366\t \001(\0132$.ChannellerSlabLoopDungeonResul" +
      "tInfoH\000\022R\n$effigy_challenge_dungeon_resu" +
      "lt_info\030\370\016 \001(\0132!.EffigyChallengeDungeonR" +
    ...
    internal_static_DungeonChallengeFinishNotify_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_DungeonChallengeFinishNotify_descriptor,
        new java.lang.String[] { "StrengthenPointDataMap", "ChallengeIndex", "IsNewRecord", "IsSuccess", "FinishType", "TimeCost", "ChallengeRecordType", "CurrentValue", "CustomDungeonResultInfo", "PotionDungeonResultInfo", "ChannellerSlabLoopDungeonResultInfo", "EffigyChallengeDungeonResultInfo", "Detail", });
    internal_static_DungeonChallengeFinishNotify_StrengthenPointDataMapEntry_descriptor =
