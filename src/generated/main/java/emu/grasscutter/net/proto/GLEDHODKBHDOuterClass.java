...
// source: GLEDHODKBHD.proto

package emu.grasscutter.net.proto;

public final class GLEDHODKBHDOuterClass {
  private GLEDHODKBHDOuterClass() {}
  ...
  public interface GLEDHODKBHDOrBuilder extends
      // @@protoc_insertion_point(interface_extends:GLEDHODKBHD)
    ...
    /**
     * <code>.MapLayerInfo map_layer_info = 5;</code>
    ...
    /**
     * <code>uint32 FMADMBGGPBI = 13;</code>
     * @return The fMADMBGGPBI.
     */
    int getFMADMBGGPBI();
  }
  /**
   * Protobuf type {@code GLEDHODKBHD}
   */
  public static final class GLEDHODKBHD extends
      com.google.protobuf.GeneratedMessageV3 implements
      // @@protoc_insertion_point(message_implements:GLEDHODKBHD)
      GLEDHODKBHDOrBuilder {
  private static final long serialVersionUID = 0L;
    // Use GLEDHODKBHD.newBuilder() to construct.
    private GLEDHODKBHD(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
      super(builder);
    }
    private GLEDHODKBHD() {
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.internal_static_GLEDHODKBHD_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.internal_static_GLEDHODKBHD_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.GLEDHODKBHD.class, emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.GLEDHODKBHD.Builder.class);
    }
    ...
    public static final int MAP_LAYER_INFO_FIELD_NUMBER = 5;
    ...
    public static final int FMADMBGGPBI_FIELD_NUMBER = 13;
    private int fMADMBGGPBI_;
    /**
     * <code>uint32 FMADMBGGPBI = 13;</code>
     * @return The fMADMBGGPBI.
     */
    @java.lang.Override
    public int getFMADMBGGPBI() {
      return fMADMBGGPBI_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      getSerializedSize();
      if (mapLayerInfo_ != null) {
        output.writeMessage(5, getMapLayerInfo());
      }
      ...
      if (fMADMBGGPBI_ != 0) {
        output.writeUInt32(13, fMADMBGGPBI_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (mapLayerInfo_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(5, getMapLayerInfo());
      }
      {
        int dataSize = 0;
        for (int i = 0; i < sceneTagIdList_.size(); i++) {
      ...
      if (fMADMBGGPBI_ != 0) {
        size += com.google.protobuf.CodedOutputStream
          .computeUInt32Size(13, fMADMBGGPBI_);
      }
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.GLEDHODKBHD)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.GLEDHODKBHD other = (emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.GLEDHODKBHD) obj;
      ...
      if (getFMADMBGGPBI()
          != other.getFMADMBGGPBI()) return false;
    ...
    public int hashCode() {
      ...
      hash = (37 * hash) + FMADMBGGPBI_FIELD_NUMBER;
      hash = (53 * hash) + getFMADMBGGPBI();
      hash = (29 * hash) + unknownFields.hashCode();
      memoizedHashCode = hash;
      return hash;
    }

    public static emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.GLEDHODKBHD parseFrom(
    ...
    public static emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.GLEDHODKBHD parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.GLEDHODKBHD parseFrom(
    ...
    public static emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.GLEDHODKBHD parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.GLEDHODKBHD parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.GLEDHODKBHD parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.GLEDHODKBHD prototype) {
    ...
    public static final class Builder extends
        ...
        // @@protoc_insertion_point(builder_implements:GLEDHODKBHD)
        emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.GLEDHODKBHDOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.internal_static_GLEDHODKBHD_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.GLEDHODKBHD.newBuilder()
      private Builder() {
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.GLEDHODKBHD getDefaultInstanceForType() {
        return emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.GLEDHODKBHD.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.GLEDHODKBHD build() {
        emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.GLEDHODKBHD result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.GLEDHODKBHD buildPartial() {
        emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.GLEDHODKBHD result = new emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.GLEDHODKBHD(this);
        ...
        result.fMADMBGGPBI_ = fMADMBGGPBI_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.GLEDHODKBHD) {
          return mergeFrom((emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.GLEDHODKBHD)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.GLEDHODKBHD other) {
        if (other == emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.GLEDHODKBHD.getDefaultInstance()) return this;
        ...
        if (other.getFMADMBGGPBI() != 0) {
          setFMADMBGGPBI(other.getFMADMBGGPBI());
        }
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.GLEDHODKBHD parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.GLEDHODKBHD) e.getUnfinishedMessage();
      ...
      /**
       * <code>uint32 FMADMBGGPBI = 13;</code>
       * @param value The fMADMBGGPBI to set.
       * @return This builder for chaining.
       */
      public Builder setFMADMBGGPBI(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearFMADMBGGPBI() {
      ...
      // @@protoc_insertion_point(builder_scope:GLEDHODKBHD)
    }

    // @@protoc_insertion_point(class_scope:GLEDHODKBHD)
    private static final emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.GLEDHODKBHD DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.GLEDHODKBHD();
    }

    public static emu.grasscutter.net.proto.GLEDHODKBHDOuterClass.GLEDHODKBHD getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }

    private static final com.google.protobuf.Parser<GLEDHODKBHD>
        PARSER = new com.google.protobuf.AbstractParser<GLEDHODKBHD>() {
      @java.lang.Override
      public GLEDHODKBHD parsePartialFrom(
          com.google.protobuf.CodedInputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return new GLEDHODKBHD(input, extensionRegistry);
      }
    };

    public static com.google.protobuf.Parser<GLEDHODKBHD> parser() {
      return PARSER;
    }

    @java.lang.Override
    public com.google.protobuf.Parser<GLEDHODKBHD> getParserForType() {
      return PARSER;
    }
  ...
  private static final com.google.protobuf.Descriptors.Descriptor
    internal_static_GLEDHODKBHD_descriptor;
  private static final 
    com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internal_static_GLEDHODKBHD_fieldAccessorTable;
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\021GLEDHODKBHD.proto\032\022MapLayerInfo.proto\"" +
      "d\n\013GLEDHODKBHD\022\031\n\021scene_tag_id_list\030\n \003(" +
      "\r\022%\n\016map_layer_info\030\005 \001(\0132\r.MapLayerInfo" +
      "\022\023\n\013FMADMBGGPBI\030\r \001(\rB\033\n\031emu.grasscutter" +
    ...
    internal_static_GLEDHODKBHD_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_GLEDHODKBHD_descriptor,
        new java.lang.String[] { "SceneTagIdList", "MapLayerInfo", "FMADMBGGPBI", });
    emu.grasscutter.net.proto.MapLayerInfoOuterClass.getDescriptor();
  }
