...
public final class HomeAvatarSummonAllEventNotifyOuterClass {
  ...
  public interface HomeAvatarSummonAllEventNotifyOrBuilder extends
    ...
    /**
     * <code>repeated .HomeAvatarSummonEventInfo summon_event_list = 9;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int SUMMON_EVENT_LIST_FIELD_NUMBER = 9;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < summonEventList_.size(); i++) {
        output.writeMessage(9, summonEventList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < summonEventList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(9, summonEventList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "t_list\030\t \003(\0132\032.HomeAvatarSummonEventInfo" +
