...
public final class HomeAvatarTalkRspOuterClass {
  ...
  public interface HomeAvatarTalkRspOrBuilder extends
    ...
    /**
     * <code>.HomeAvatarTalkFinishInfo avatar_talk_info = 2;</code>
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int AVATAR_TALK_INFO_FIELD_NUMBER = 2;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (avatarTalkInfo_ != null) {
        output.writeMessage(2, getAvatarTalkInfo());
      }
      if (retcode_ != 0) {
    ...
    public int getSerializedSize() {
      ...
      if (avatarTalkInfo_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(2, getAvatarTalkInfo());
      }
      if (retcode_ != 0) {
        size += com.google.protobuf.CodedOutputStream
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "\n\007retcode\030\010 \001(\005\0223\n\020avatar_talk_info\030\002 \001(" +
