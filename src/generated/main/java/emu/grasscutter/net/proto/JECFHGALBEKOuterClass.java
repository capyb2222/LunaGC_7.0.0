...
// source: JECFHGALBEK.proto

package emu.grasscutter.net.proto;

public final class JECFHGALBEKOuterClass {
  private JECFHGALBEKOuterClass() {}
  ...
  public interface JECFHGALBEKOrBuilder extends
      // @@protoc_insertion_point(interface_extends:JECFHGALBEK)
      com.google.protobuf.MessageOrBuilder {

    /**
     * <code>.MailTextContent KGHFPBKNELH = 4;</code>
     * @return Whether the kGHFPBKNELH field is set.
     */
    boolean hasKGHFPBKNELH();
    /**
     * <code>.MailTextContent KGHFPBKNELH = 4;</code>
     * @return The kGHFPBKNELH.
     */
    emu.grasscutter.net.proto.MailTextContentOuterClass.MailTextContent getKGHFPBKNELH();
    /**
     * <code>.MailTextContent KGHFPBKNELH = 4;</code>
     */
    emu.grasscutter.net.proto.MailTextContentOuterClass.MailTextContentOrBuilder getKGHFPBKNELHOrBuilder();
  ...
  /**
   * Protobuf type {@code JECFHGALBEK}
   */
  public static final class JECFHGALBEK extends
      com.google.protobuf.GeneratedMessageV3 implements
      // @@protoc_insertion_point(message_implements:JECFHGALBEK)
      JECFHGALBEKOrBuilder {
  private static final long serialVersionUID = 0L;
    // Use JECFHGALBEK.newBuilder() to construct.
    private JECFHGALBEK(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
      super(builder);
    }
    private JECFHGALBEK() {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34: {
              ...
              if (kGHFPBKNELH_ != null) {
                subBuilder = kGHFPBKNELH_.toBuilder();
              }
              kGHFPBKNELH_ = input.readMessage(emu.grasscutter.net.proto.MailTextContentOuterClass.MailTextContent.parser(), extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom(kGHFPBKNELH_);
                kGHFPBKNELH_ = subBuilder.buildPartial();
              }
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return emu.grasscutter.net.proto.JECFHGALBEKOuterClass.internal_static_JECFHGALBEK_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return emu.grasscutter.net.proto.JECFHGALBEKOuterClass.internal_static_JECFHGALBEK_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              emu.grasscutter.net.proto.JECFHGALBEKOuterClass.JECFHGALBEK.class, emu.grasscutter.net.proto.JECFHGALBEKOuterClass.JECFHGALBEK.Builder.class);
    }

    public static final int KGHFPBKNELH_FIELD_NUMBER = 4;
    private emu.grasscutter.net.proto.MailTextContentOuterClass.MailTextContent kGHFPBKNELH_;
    /**
     * <code>.MailTextContent KGHFPBKNELH = 4;</code>
     * @return Whether the kGHFPBKNELH field is set.
     */
    @java.lang.Override
    public boolean hasKGHFPBKNELH() {
      return kGHFPBKNELH_ != null;
    }
    /**
     * <code>.MailTextContent KGHFPBKNELH = 4;</code>
     * @return The kGHFPBKNELH.
     */
    @java.lang.Override
    public emu.grasscutter.net.proto.MailTextContentOuterClass.MailTextContent getKGHFPBKNELH() {
      return kGHFPBKNELH_ == null ? emu.grasscutter.net.proto.MailTextContentOuterClass.MailTextContent.getDefaultInstance() : kGHFPBKNELH_;
    }
    /**
     * <code>.MailTextContent KGHFPBKNELH = 4;</code>
     */
    @java.lang.Override
    public emu.grasscutter.net.proto.MailTextContentOuterClass.MailTextContentOrBuilder getKGHFPBKNELHOrBuilder() {
      return getKGHFPBKNELH();
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (kGHFPBKNELH_ != null) {
        output.writeMessage(4, getKGHFPBKNELH());
      }
    ...
    public int getSerializedSize() {
      ...
      if (kGHFPBKNELH_ != null) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(4, getKGHFPBKNELH());
      }
      for (int i = 0; i < itemList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!(obj instanceof emu.grasscutter.net.proto.JECFHGALBEKOuterClass.JECFHGALBEK)) {
        return super.equals(obj);
      }
      emu.grasscutter.net.proto.JECFHGALBEKOuterClass.JECFHGALBEK other = (emu.grasscutter.net.proto.JECFHGALBEKOuterClass.JECFHGALBEK) obj;

      if (hasKGHFPBKNELH() != other.hasKGHFPBKNELH()) return false;
      if (hasKGHFPBKNELH()) {
        if (!getKGHFPBKNELH()
            .equals(other.getKGHFPBKNELH())) return false;
      }
    ...
    public int hashCode() {
      ...
      if (hasKGHFPBKNELH()) {
        hash = (37 * hash) + KGHFPBKNELH_FIELD_NUMBER;
        hash = (53 * hash) + getKGHFPBKNELH().hashCode();
      }
    ...
    public static emu.grasscutter.net.proto.JECFHGALBEKOuterClass.JECFHGALBEK parseFrom(
    ...
    public static emu.grasscutter.net.proto.JECFHGALBEKOuterClass.JECFHGALBEK parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static emu.grasscutter.net.proto.JECFHGALBEKOuterClass.JECFHGALBEK parseFrom(
    ...
    public static emu.grasscutter.net.proto.JECFHGALBEKOuterClass.JECFHGALBEK parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static emu.grasscutter.net.proto.JECFHGALBEKOuterClass.JECFHGALBEK parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static emu.grasscutter.net.proto.JECFHGALBEKOuterClass.JECFHGALBEK parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(emu.grasscutter.net.proto.JECFHGALBEKOuterClass.JECFHGALBEK prototype) {
    ...
    public static final class Builder extends
        ...
        // @@protoc_insertion_point(builder_implements:JECFHGALBEK)
        emu.grasscutter.net.proto.JECFHGALBEKOuterClass.JECFHGALBEKOrBuilder {
      public static final com.google.protobuf.Descriptors.Descriptor
          getDescriptor() {
        return emu.grasscutter.net.proto.JECFHGALBEKOuterClass.internal_static_JECFHGALBEK_descriptor;
      }
      ...
      // Construct using emu.grasscutter.net.proto.JECFHGALBEKOuterClass.JECFHGALBEK.newBuilder()
      private Builder() {
      ...
      public Builder clear() {
        super.clear();
        if (kGHFPBKNELHBuilder_ == null) {
          kGHFPBKNELH_ = null;
        } else {
          kGHFPBKNELH_ = null;
          kGHFPBKNELHBuilder_ = null;
        }
        argumentList_ = com.google.protobuf.LazyStringArrayList.EMPTY;
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.JECFHGALBEKOuterClass.JECFHGALBEK getDefaultInstanceForType() {
        return emu.grasscutter.net.proto.JECFHGALBEKOuterClass.JECFHGALBEK.getDefaultInstance();
      }

      @java.lang.Override
      public emu.grasscutter.net.proto.JECFHGALBEKOuterClass.JECFHGALBEK build() {
        emu.grasscutter.net.proto.JECFHGALBEKOuterClass.JECFHGALBEK result = buildPartial();
      ...
      @java.lang.Override
      public emu.grasscutter.net.proto.JECFHGALBEKOuterClass.JECFHGALBEK buildPartial() {
        emu.grasscutter.net.proto.JECFHGALBEKOuterClass.JECFHGALBEK result = new emu.grasscutter.net.proto.JECFHGALBEKOuterClass.JECFHGALBEK(this);
        int from_bitField0_ = bitField0_;
        if (kGHFPBKNELHBuilder_ == null) {
          result.kGHFPBKNELH_ = kGHFPBKNELH_;
        } else {
          result.kGHFPBKNELH_ = kGHFPBKNELHBuilder_.build();
        }
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof emu.grasscutter.net.proto.JECFHGALBEKOuterClass.JECFHGALBEK) {
          return mergeFrom((emu.grasscutter.net.proto.JECFHGALBEKOuterClass.JECFHGALBEK)other);
        } else {
      ...
      public Builder mergeFrom(emu.grasscutter.net.proto.JECFHGALBEKOuterClass.JECFHGALBEK other) {
        if (other == emu.grasscutter.net.proto.JECFHGALBEKOuterClass.JECFHGALBEK.getDefaultInstance()) return this;
        if (other.hasKGHFPBKNELH()) {
          mergeKGHFPBKNELH(other.getKGHFPBKNELH());
        }
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        emu.grasscutter.net.proto.JECFHGALBEKOuterClass.JECFHGALBEK parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (emu.grasscutter.net.proto.JECFHGALBEKOuterClass.JECFHGALBEK) e.getUnfinishedMessage();
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          emu.grasscutter.net.proto.MailTextContentOuterClass.MailTextContent, emu.grasscutter.net.proto.MailTextContentOuterClass.MailTextContent.Builder, emu.grasscutter.net.proto.MailTextContentOuterClass.MailTextContentOrBuilder> kGHFPBKNELHBuilder_;
      /**
       * <code>.MailTextContent KGHFPBKNELH = 4;</code>
       * @return Whether the kGHFPBKNELH field is set.
       */
      public boolean hasKGHFPBKNELH() {
        return kGHFPBKNELHBuilder_ != null || kGHFPBKNELH_ != null;
      }
      /**
       * <code>.MailTextContent KGHFPBKNELH = 4;</code>
       * @return The kGHFPBKNELH.
      ...
      public emu.grasscutter.net.proto.MailTextContentOuterClass.MailTextContent getKGHFPBKNELH() {
        if (kGHFPBKNELHBuilder_ == null) {
          ...
          return kGHFPBKNELHBuilder_.getMessage();
        }
      }
      /**
       * <code>.MailTextContent KGHFPBKNELH = 4;</code>
       */
      public Builder setKGHFPBKNELH(emu.grasscutter.net.proto.MailTextContentOuterClass.MailTextContent value) {
        if (kGHFPBKNELHBuilder_ == null) {
          if (value == null) {
          ...
          kGHFPBKNELHBuilder_.setMessage(value);
        }
       ...
       * <code>.MailTextContent KGHFPBKNELH = 4;</code>
       */
      public Builder setKGHFPBKNELH(
          emu.grasscutter.net.proto.MailTextContentOuterClass.MailTextContent.Builder builderForValue) {
        if (kGHFPBKNELHBuilder_ == null) {
          kGHFPBKNELH_ = builderForValue.build();
          onChanged();
        } else {
          kGHFPBKNELHBuilder_.setMessage(builderForValue.build());
        }
       ...
       * <code>.MailTextContent KGHFPBKNELH = 4;</code>
       */
      public Builder mergeKGHFPBKNELH(emu.grasscutter.net.proto.MailTextContentOuterClass.MailTextContent value) {
        if (kGHFPBKNELHBuilder_ == null) {
          if (kGHFPBKNELH_ != null) {
            kGHFPBKNELH_ =
              emu.grasscutter.net.proto.MailTextContentOuterClass.MailTextContent.newBuilder(kGHFPBKNELH_).mergeFrom(value).buildPartial();
          } else {
            kGHFPBKNELH_ = value;
          }
          onChanged();
        } else {
          kGHFPBKNELHBuilder_.mergeFrom(value);
        }
       ...
       * <code>.MailTextContent KGHFPBKNELH = 4;</code>
       */
      public Builder clearKGHFPBKNELH() {
        if (kGHFPBKNELHBuilder_ == null) {
          kGHFPBKNELH_ = null;
          onChanged();
        } else {
       ...
       * <code>.MailTextContent KGHFPBKNELH = 4;</code>
       */
      public emu.grasscutter.net.proto.MailTextContentOuterClass.MailTextContent.Builder getKGHFPBKNELHBuilder() {
        
        onChanged();
        return getKGHFPBKNELHFieldBuilder().getBuilder();
      }
      /**
       * <code>.MailTextContent KGHFPBKNELH = 4;</code>
       */
      public emu.grasscutter.net.proto.MailTextContentOuterClass.MailTextContentOrBuilder getKGHFPBKNELHOrBuilder() {
        if (kGHFPBKNELHBuilder_ != null) {
          return kGHFPBKNELHBuilder_.getMessageOrBuilder();
        } else {
          return kGHFPBKNELH_ == null ?
              emu.grasscutter.net.proto.MailTextContentOuterClass.MailTextContent.getDefaultInstance() : kGHFPBKNELH_;
        }
      }
      /**
       * <code>.MailTextContent KGHFPBKNELH = 4;</code>
      ...
      private com.google.protobuf.SingleFieldBuilderV3<
          ...
          getKGHFPBKNELHFieldBuilder() {
        if (kGHFPBKNELHBuilder_ == null) {
          kGHFPBKNELHBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
              emu.grasscutter.net.proto.MailTextContentOuterClass.MailTextContent, emu.grasscutter.net.proto.MailTextContentOuterClass.MailTextContent.Builder, emu.grasscutter.net.proto.MailTextContentOuterClass.MailTextContentOrBuilder>(
                  getKGHFPBKNELH(),
  ...
  checkByteStringIsUtf8(value);
      ...
      // @@protoc_insertion_point(builder_scope:JECFHGALBEK)
    }

    // @@protoc_insertion_point(class_scope:JECFHGALBEK)
    private static final emu.grasscutter.net.proto.JECFHGALBEKOuterClass.JECFHGALBEK DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new emu.grasscutter.net.proto.JECFHGALBEKOuterClass.JECFHGALBEK();
    }

    public static emu.grasscutter.net.proto.JECFHGALBEKOuterClass.JECFHGALBEK getDefaultInstance() {
      return DEFAULT_INSTANCE;
    }

    private static final com.google.protobuf.Parser<JECFHGALBEK>
        PARSER = new com.google.protobuf.AbstractParser<JECFHGALBEK>() {
      @java.lang.Override
      public JECFHGALBEK parsePartialFrom(
          com.google.protobuf.CodedInputStream input,
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws com.google.protobuf.InvalidProtocolBufferException {
        return new JECFHGALBEK(input, extensionRegistry);
      }
    };

    public static com.google.protobuf.Parser<JECFHGALBEK> parser() {
      return PARSER;
    }

    @java.lang.Override
    public com.google.protobuf.Parser<JECFHGALBEK> getParserForType() {
      return PARSER;
    }
  ...
  private static final com.google.protobuf.Descriptors.Descriptor
    internal_static_JECFHGALBEK_descriptor;
  private static final 
    com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internal_static_JECFHGALBEK_fieldAccessorTable;
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\021JECFHGALBEK.proto\032\025MailTextContent.pro" +
      "to\032\016MailItem.proto\032\026MailCollectState.pro" +
      "to\"\237\002\n\013JECFHGALBEK\022%\n\013KGHFPBKNELH\030\004 \001(\0132" +
      ...
      "tate\030\017 \001(\0162\021.MailCollectState\022\017\n\007is_read" +
    ...
    internal_static_JECFHGALBEK_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_JECFHGALBEK_descriptor,
        new java.lang.String[] { "KGHFPBKNELH", "ArgumentList", "ItemList", "SendTime", "ExpireTime", "Importance", "MailId", "CollectState", "IsRead", "IsAttachmentGot", "ConfigId", });
    emu.grasscutter.net.proto.MailTextContentOuterClass.getDescriptor();
    emu.grasscutter.net.proto.MailItemOuterClass.getDescriptor();
    emu.grasscutter.net.proto.MailCollectStateOuterClass.getDescriptor();
  }
