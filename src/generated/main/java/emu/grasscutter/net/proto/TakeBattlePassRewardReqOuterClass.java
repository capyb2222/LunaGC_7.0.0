...
public final class TakeBattlePassRewardReqOuterClass {
  ...
  public interface TakeBattlePassRewardReqOrBuilder extends
    ...
    /**
     * <code>repeated .BattlePassRewardTakeOption take_option_list = 6;</code>
     */
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final int TAKE_OPTION_LIST_FIELD_NUMBER = 6;
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      for (int i = 0; i < takeOptionList_.size(); i++) {
        output.writeMessage(6, takeOptionList_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      for (int i = 0; i < takeOptionList_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(6, takeOptionList_.get(i));
      }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "assRewardReq\0225\n\020take_option_list\030\006 \003(\0132\033" +
      ".BattlePassRewardTakeOptionB>\n\031emu.grass" +
      "cutter.net.protoB!TakeBattlePassRewardRe" +
